...
\byustylesetup{
	...
	committeememberc  = Michael Bush,                    % PhD Only
...
\hypersetup{
	...
	pdfpagemode        = {UseOutlines}, %  Specify how document starts when opened ({None}).
	 ...
	 pdftitle    = {Hybrid Word Boundary Detection: Morphology with Statistics},
...
% Define Title & Author
\title{Hybrid Word Boundary Detection: Morphology with Statistics}
